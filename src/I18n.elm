...
fr =
    { -- App Info
      appTitle = "Train Like Pro"
    , appSubtitle = "Système de gamification pour le BJJ"
    , language = "Langue"
    , loading = "Chargement..."
    ...
    , helpComingSoon = "La documentation d'aide arrive bientôt. En attendant, explore l'application pour progresser."
    ...
    , todaysFocusSubtitle = "Ta mission d'entraînement active"
    , startYourJourney = "Commence ton aventure"
    , createAccount = "Crée un compte pour suivre tes progrès, enregistrer tes favoris et débloquer des succès."
    ...
    , currentDrill = "EXERCICE EN COURS"
    , sessionXP = "XP DE SESSION"
    , techniques = "TECHNIQUES"
    , endSession = "TERMINER LA SESSION"
    , startTraining = "COMMENCER L'ENTRAÎNEMENT"
    , readyToTrain = "PRÊT À T'ENTRAÎNER ?"
    , readyToTrainSubtitle = "Lance ta session pour gagner de l'XP et suivre ta progression."
    , noActiveSession = "Aucune session active"
    , selectTechnique = "CHOISIR UNE TECHNIQUE"
    , chooseNextTechnique = "Choisis ta prochaine technique"
    , addRep = "AJOUTER UNE RÉP"
    , perfect = "PARFAIT !"
    ...
    , allQuestsCompleted = "TOUTES LES QUÊTES SONT VALIDÉES !"
    , comeBackTomorrow = "Reviens demain pour de nouveaux défis"
    ...
    , learningPathways = "Tes parcours d'apprentissage"
    , noActiveRoadmaps = "Aucun parcours actif. Lance ton voyage d'apprentissage !"
    ...
    -- Messages & Notifications
    , signUpFeature = "L'inscription en ligne arrive bientôt !"
    , loginFeature = "La connexion arrive bientôt !"
    , comingSoon = "Bientôt disponible !"
    , helpDocumentation = "La documentation d'aide arrive bientôt. Explore l'application entre-temps."
    , goalSettingFeature = "La création d'objectifs arrive bientôt !"
    , externalLink = "Ce lien externe s'ouvrira dans un nouvel onglet"
    ...
    , register = "S'inscrire"
    , watchStream = "Regarder le direct"
    , save = "Enregistrer"
    , cancel = "Annuler"
    , close = "Fermer"
    , confirm = "Confirmer"
    ...
    , readyToMaster = "Prêt à maîtriser de nouvelles techniques ? Ton voyage continue aujourd'hui."
    , techniquesLearned = "Techniques apprises"
    , weeklyBonus = "Bonus XP hebdomadaire"
    , completeAllGoals = "Valider tous les objectifs"
    ...
    , losses = "Défaites"
    , draws = "Matchs nuls"
    , signatureTechniques = "Techniques signatures"
    , videos = "Vidéos"
    ...
    , heroTitleHighlight = "clé en main"
    ...
    , fighterPathComingSoon = "Le système de parcours combattant arrive bientôt !"
    ...
    , trainingPlansSubtitle = "Choisis un champion et suis sa méthodologie d'entraînement"
    ...
    -- Modals & Animations
    , logTrainingSession = "Journal de session"
